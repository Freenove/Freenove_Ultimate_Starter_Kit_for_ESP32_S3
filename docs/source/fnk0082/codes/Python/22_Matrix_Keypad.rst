...
Open “Thonny”, click “This computer” -> “D:” -> “Micropython_Codes” ->  “22.1_Matrix_Keypad”. Select“keypad.py”, right click your mouse to select “Upload to /”, wait for “keypad.py” to be uploaded to ESP32-S3 and then double click “Matrix_Keypad.py”. 
...
Associate the keypad module to ESP32-S3 pins. 
...
.. py:function:: Class keypad
    ...
    Before each use of the object **KeyPad** , please make sure **keypad.py** has been uploaded to “/” of ESP32-S3 and then add the statement “ **from keypad import KeyPad** ” to the top of python file.

    **KeyPad(row1,row2,row3,row4,col1,col2,col3,col4):** Intialize keypad module and associate its pins with ESP32-S3.
