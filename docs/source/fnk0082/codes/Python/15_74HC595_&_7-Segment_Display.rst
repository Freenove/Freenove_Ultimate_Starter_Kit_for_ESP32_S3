...
| |Chapter01_02|                                                            |
+-------------------+------------------+------------------------------------+
| 74HC595 x1        | Resistor 220Ω x8 | 7-segment display x1               |
|                   |                  |                                    |
| |Chapter15_00|    | |Chapter01_04|   | |Chapter16_00|                     |
+-------------------+------------------+------------------------------------+
| Jumper M/M                                                                |
|                                                                           |
|   |Chapter01_05|                                                          |
...
| 74HC595 x1        | Resistor 220Ω x8 | 7-segment display x1               |
|                   |                  |                                    |
| |Chapter15_00|    | |Chapter01_04|   | |Chapter16_07|                     |
+-------------------+------------------+------------------------------------+
| Jumper M/M                                                                |
|                                                                           |
|   |Chapter01_05|                                                          |
...
.. image:: ../_static/imgs/16_74HC595_&_7-Segment_Display/Chapter16_10.png
    :align: center

Click “Run current script”, and the Nixie tube display as shown in the image below.

.. image:: ../_static/imgs/16_74HC595_&_7-Segment_Display/Chapter16_11.png
    :align: center
