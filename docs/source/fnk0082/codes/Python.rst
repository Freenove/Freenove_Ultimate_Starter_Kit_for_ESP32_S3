...
.. toctree::
   ...
   Python/5_RGB_LED.rst
   Python/6_LEDPixel.rst
   Python/7_Buzzer.rst
   Python/8_Serial_Communication.rst
   Python/9_AD_Converter.rst
   Python/10_Potentiometer_&_LED.rst
   Python/11_Photoresistor_&_LED.rst
   Python/12_Thermistor.rst
   Python/13_Joystick.rst
   Python/14_74HC595_&_LED_Bar_Graph.rst
   ...
   Python/22_Matrix_Keypad.rst
   Python/23_Infrared_Remote.rst
   Python/24_Hygrothermograph_DHT11.rst
   Python/25_Infrared_Motion_Sensor.rst
   Python/26_Attitude_Sensor_MPU6050.rst
