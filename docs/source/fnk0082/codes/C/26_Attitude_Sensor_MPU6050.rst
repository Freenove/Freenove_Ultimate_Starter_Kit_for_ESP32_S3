...
| |Chapter01_02|                                                 |
+-----------------------------+----------------------------------+
| MPU6050 x1                  | Jumper F/M x3                    |
|                             |                                  |
| |Chapter26_00|              |  |Chapter19_02|                  |
+-----------------------------+----------------------------------+
...
We use the third party library MPU6050_tockn. If you haven't installed it yet, please do so now. The steps to add third-party Libraries are as follows: open arduino->Sketch->Include library-> Manage libraries. 
