...
For example, generate a PWM with an 8-bit precision (28=256. Values range from 0 to 255) with a maximum frequency of 80,000,000/256 = 312,500Hz.
...
.. py:function:: void ledcAttachChannel (uint8_t pin, double freq, uint8_t bit_num, uint8_t channel);
.. py:function:: void ledcDetachPin(uint8_t pin);
...
| |Chapter01_02|                                                 |
+-------------------+------------------+-------------------------+
| LED bar graph x1  | Resistor 220Ω x8 | Jumper M/M x8           |
|                   |                  |                         |
